/**
 * Tệp tin: ongkinh.js
 * Chức năng: Xử lý logic và nghiệp vụ liên quan đến ongkinh
...
document.addEventListener("DOMContentLoaded", function() {
    ...
    // ── Render Giao Diện Danh Sách Ống Kính ────────────────────────────────
    // 1. Lọc sản phẩm theo danh mục 'lens', thương hiệu (brand) và từ khóa tìm kiếm (search)
